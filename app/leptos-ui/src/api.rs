...
/// Delete a worktree via `DELETE /api/worktrees/{id}[?force=true]` (HTTP) or
/// `cmd_delete_worktree` (Tauri IPC).
///
...
/// silently dropped. `cmd_delete_worktree` mirrors this same force semantics
/// on the Tauri side.
